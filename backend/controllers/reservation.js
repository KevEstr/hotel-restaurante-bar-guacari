...
exports.createReservation = asyncHandler(async (req, res) => {
    const { price, start_date, end_date, quantity, clientId, note, paymentId, is_paid, rooms, total } = req.body;
...
exports.getReservations = asyncHandler(async (req, res) => {
    ...
    let options = {
        ...
        attributes: {
            exclude: ["userId", "clientId", "updatedAt"],
        },
        reservation: [["id", "DESC"]],
...
exports.updateReservation = asyncHandler(async (req, res) => {
    ...
    if (reservation) {
        const { price, start_date, end_date, quantity, clientId, note, paymentId, is_paid, total} = req.body;
