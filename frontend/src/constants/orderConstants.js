...
export const CLIENT_ORDER_LIST_REQUEST = 'CLIENT_ORDER_LIST_REQUEST';
export const CLIENT_ORDER_LIST_SUCCESS = 'CLIENT_ORDER_LIST_SUCCESS';
export const CLIENT_ORDER_LIST_FAIL = 'CLIENT_ORDER_LIST_FAIL';
export const CLIENT_ORDER_LIST_RESET = 'CLIENT_ORDER_LIST_RESET';
