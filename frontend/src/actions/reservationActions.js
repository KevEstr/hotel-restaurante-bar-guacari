...
export const listAllReservations = ({ keyword = '', pageNumber = '', startDate='', endDate='', paymentId=''}) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`/api/reservations`, {
            params: { keyword, pageNumber, startDate, endDate, paymentId },
            ...config,
        });
